...
//
//      Estas rutinas ofrecen conversiones entre entidades XML y su respectiva representacion unicode
//
//      ej:
//              &#9827; -> ? -> &#9827;
//              &pi; -> p -> &#960;
//
//      Note que las entidades con nombre son sensibles a letras mayusculas o minusculas.
//      "&acirc;" no es lo mismo que "&Acirc;".
//
...
// Convierte una entidad HTML numerica simple a un token UTF-8 regular de GO.
...
// Convierte un token UTF-8 regular de GO en una entidad HTML.
